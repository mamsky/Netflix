...
const App = () => {
  ...
  return (
    <div className="bg-black text-white w-full h-screen fixed">
      <Navbar>
        <Image
          src={Bg}
          alt="background"
          heigh="100vh"
          className="min-h-screen bg-cover block"
        />
        <div className="w-4/5 absolute top-[28%] sm:top-[40%] md:top-[38%] left-[5%]">
          <div className="grid grid-rows-2 gap-4 md:gap-0 ">
            ...
            <div>
              <div className="absolute md:-right-14">
